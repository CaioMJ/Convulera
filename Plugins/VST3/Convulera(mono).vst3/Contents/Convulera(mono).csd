...
hslider bounds(270, 126, 155, 25) range(0, 1, 1, 1, 0.001) channel("InVolume") trackercolour(188, 151, 49, 255) 

label bounds(270, 234, 158, 19) text("Out Gain") fontcolour(255, 255, 255, 255)
hslider bounds(270, 252, 155, 25) range(0, 1, 1, 1, 0.001) channel("OutVolume") trackercolour(188, 151, 49, 255) 
